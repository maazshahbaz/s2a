...
class TritonMistralClient:
    ...
    def generate_async(self, prompt: str, request_id: Optional[str] = None) -> str:
        """
...
{user_prompt} [/INST]"""
    ...
    def analyze_call_async(self, transcription: str, request_id: Optional[str] = None) -> str:
        """
...
Output ONLY the JSON object, nothing else."""
        ...
        return self.generate_async(full_prompt, request_id)
