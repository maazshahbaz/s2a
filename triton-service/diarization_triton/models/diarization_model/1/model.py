...
class TritonPythonModel:
    ...
    def initialize(self, args):
        ...
        if self.model_dir is None:
            # Default fallback
            self.model_dir = '/models/diarization'
            os.makedirs(self.model_dir, exist_ok=True)
        
        print(f"[Optimized Diarization] Using model directory: {self.model_dir}")
        self.model_dir = '/models/diarization_model/engine'
        self.vad_engine_path = os.path.join(self.model_dir, 'vad_marblenet.plan')
        self.titanet_engine_path = os.path.join(self.model_dir, 'titanet_large.plan')
